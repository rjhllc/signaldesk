...
- Replaced the liquid-glass, desaturated hero overlay and static dot grid with a steady particle conveyor: the dense input field moves right into the filter while a five-dot curated stream exits at the same speed and brightness on the black side.
